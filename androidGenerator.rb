...
class AndroidGenerator
  ...
  def generate_default(protocol,projectName,packageName,aVersion,aOutput)
  ...
  ##########################################
  ##CLOSE TO BE DEPRECATED!

  def generate_1_0(protocol,projectName,packageName,aVersion,aOutput,mode)
    puts 'Android Generation'
    puts '------------------'
    ###################################
    # ANDROID GENERATION
